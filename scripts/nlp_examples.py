...
np = NounParser()
print(
    np.get_phrases("This is the biggest, fuzziest narwhal I have ever seen in my life!")
)


ft_model = fasttext.load_model("data/cc.en.50.bin")
print(
    ft_model.get_sentence_vector("This is the fuzziest narwhal I've seen in my life!")
)